...
master_modello[, DSI_tipo_pratica := as.character(DSI_tipo_pratica)]
...
#saveRDS(modello,file.path('modelli',paste0('modello_',segmento,suffix,'.RDS')))
